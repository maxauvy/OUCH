...
const en: Translations = {
  ...
  trends: {
    ...
    whatHelps: 'What your best days have in common',
    bucketWith: 'With',
    bucketWithout: 'Without',
    insightTagHigher: 'On days with {{label}}, your average pain is {{diff}} {{points}} higher.',
    insightTagLower: 'On days with {{label}}, your average pain is {{diff}} {{points}} lower.',
  },
