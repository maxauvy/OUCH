...
const fr: Translations = {
  ...
  trends: {
    ...
    whatHelps: 'Ce qui accompagne tes meilleurs jours',
    bucketWith: 'Avec',
    bucketWithout: 'Sans',
    insightTagHigher: 'Les jours avec {{label}}, ta douleur moyenne est {{diff}} {{points}} plus haute.',
    insightTagLower: 'Les jours avec {{label}}, ta douleur moyenne est {{diff}} {{points}} plus basse.',
  },
